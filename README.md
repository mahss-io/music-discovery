## LMLJ Discovery
I created this project for a few reasons. One, every other solution I tried was over engineered (so is this one but I tied keeping it simple). Two I wanted to limit calls to all the services I could (still makes quite a few). Three wanted to minimized the amount of music obtained.

_Fuck I need a readme. There is no way this is going to be a small project._

### Custom Local Stored Playlist Format (Outdated)
```json
{
    "listenbrainzId": "<uuid>",
